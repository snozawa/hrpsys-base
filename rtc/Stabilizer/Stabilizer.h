  ...
  : public RTC::DataFlowComponentBase
{
 ...
 protected:
  ...
  OpenHRP::StabilizerService::TimedSerializedStateData m_serializedStateData;
  // for debug ouput
  ...
  RTC::OutPort<OpenHRP::StabilizerService::TimedSerializedStateData> m_serializedStateDataOut;
  // for debug output
