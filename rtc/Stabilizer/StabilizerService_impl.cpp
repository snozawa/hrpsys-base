...
CORBA::Boolean StabilizerService_impl::getParameter(OpenHRP::StabilizerService::stParam_out i_param)
{
  i_param = new OpenHRP::StabilizerService::stParam();
  return m_stabilizer->getParameter(*i_param);
};

CORBA::Boolean StabilizerService_impl::setParameter(const OpenHRP::StabilizerService::stParam& i_stp)
{
	return m_stabilizer->setParameter(i_stp);
}
